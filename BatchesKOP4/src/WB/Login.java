...
public class Login {
	...
	public Login() {
		initialize();
		connection=MariaDBConnection2HacoSoftDB.dbConnector("Kooperacja0", "1234"); // pierwsze polaczenie z baza jest na Kooperacja0 (nie ma zadnego konta w programie na tym userze). 
																					//Sprawdza wtedy co to jest za uzytkownik i ustawia go (zamyka polaczenie Kooperacjaa0, a otwiera na odpowiednim dla uzytkownika - Kooperacja1 lub Kooperacja2) do kolejnych polaczen
	}
	...
	public void initialize() {
		...
		Image img = new ImageIcon(this.getClass().getResource("/zyrafa.png")).getImage();
		lblNewLabel_2.setIcon(new ImageIcon(img));
		lblNewLabel_2.setBounds(-62, -335, 1489, 1047);
	...
	public void NextWindow(){
		try {
			...
			if(count==1)
			{
				...
				connection.close();
				frame.dispose();
				connection=MariaDBConnection2HacoSoftDB.dbConnector(getUser(), getPass());
				ChooseTypeOfFilling mojeMenu = new ChooseTypeOfFilling(connection);
